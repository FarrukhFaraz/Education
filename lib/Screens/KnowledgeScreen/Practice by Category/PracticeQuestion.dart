...
class PracticeQuestion extends StatefulWidget {
  ...
  @override
  State<PracticeQuestion> createState() =>
      _PracticeQuestionState(questionBookId);
}

class _PracticeQuestionState extends State<PracticeQuestion> {
  _PracticeQuestionState(this.questionBookId);
  ...
  submitData() async {
    ...
    try {
      http.Response response = await http.post(
          Uri.parse(submitTopicPracticeURL),
  ...
  void initState() {
    ...
    // getList();
    setState(() {
      answerIs = widget.list[index].answer!;
      ratio = 1 / widget.list.length;
      print(ratio);
      print(answerIs);
    });
    if (widget.list[index].questionType == "3" ||
        widget.list[index].questionType == "4") {
      getAllAnswers();
    }
    super.initState();
  }
            ...
            body: loader
                ...
                : SingleChildScrollView(
                    child: Padding(
                      ...
                      child: widget.list[index].questionType == "1"
                          ? multipleChoiceText()
                          : widget.list[index].questionType == "2"
                              ? multipleChoiceImages()
                              : widget.list[index].questionType == "3"
                                  ? dragDropText()
                                  : widget.list[index].questionType == "4"
                                      ? dragDropImages()
                                      : Container(),
    ...
    return Column(
      children: [
        ...
        InkWell(
            ...
            child: multipleText("a", widget.list[index].a, click1)),
        const SizedBox(height: 10),
        InkWell(
            onTap: () {
              setState(() {
            ...
            child: multipleText("b", widget.list[index].b, click2)),
        const SizedBox(height: 10),
        InkWell(
            onTap: () {
              setState(() {
            ...
            child: multipleText("c", widget.list[index].c, click3)),
        const SizedBox(height: 10),
        InkWell(
            onTap: () {
              setState(() {
            ...
            child: multipleText("d", widget.list[index].d, click4)),
      ],
    );
  }
    ...
    return Column(
      children: [
        ...
        InkWell(
          ...
          child: multipleImage("a", widget.list[index].a.toString(), click1),
        ),
        const SizedBox(height: 10),
        InkWell(
          onTap: () {
          ...
          child: multipleImage("b", widget.list[index].b.toString(), click2),
        ),
        const SizedBox(height: 10),
        InkWell(
          onTap: () {
          ...
          child: multipleImage("c", widget.list[index].c.toString(), click3),
        ),
        const SizedBox(height: 10),
        InkWell(
            onTap: () {
            ...
            child: multipleImage("d", widget.list[index].d.toString(), click4)),
      ],
    );
  }

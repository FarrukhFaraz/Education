...
class DemoQuestion extends StatefulWidget {
  const DemoQuestion({Key? key, required this.title, required this.topicId})
      : super(key: key);
  ...
  @override
  State<DemoQuestion> createState() => _DemoQuestionState(title, topicId);
}

class _DemoQuestionState extends State<DemoQuestion> {
  _DemoQuestionState(this.title, this.topicId);
  ...
  getList() async {
    ...
    try {
      http.Response response = await http.get(
          Uri.parse(demoQuestionBookURL + topicId.toString()),
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Expanded(
              child: Text(list[index].question!,maxLines: 10,),
            )
          ],
        ),
        SizedBox(

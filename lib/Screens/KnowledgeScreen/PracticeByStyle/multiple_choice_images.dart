...
class MultipleChoiceImages extends StatefulWidget {
  const MultipleChoiceImages({
    Key? key,
    required this.title,
  ...
  @override
  State<MultipleChoiceImages> createState() =>
      _MultipleChoiceImagesState(title, topicStyle, list);
}

class _MultipleChoiceImagesState extends State<MultipleChoiceImages> {
  _MultipleChoiceImagesState(this.title, this.topicStyle, this.list);
  ...
  submitData() async {
    ...
    try {
      http.Response response = await http.post(
          Uri.parse(submitMultipleImageStyleURL),
                      ...
                      child: Column(
                        children: [
                          ...
                          InkWell(
                              ...
                              child: question(
                                  "a", list[index].a.toString(), click1)),
                          const SizedBox(height: 10),
                          InkWell(
                              onTap: () {
                                setState(() {
                              ...
                              child: question(
                                  "b", list[index].b.toString(), click2)),
                          const SizedBox(height: 10),
                          InkWell(
                              onTap: () {
                                setState(() {
                              ...
                              child: question(
                                  "c", list[index].c.toString(), click3)),
                          const SizedBox(height: 10),
                          InkWell(
                              onTap: () {
                                setState(() {
                              ...
                              child: question(
                                  "d", list[index].d.toString(), click4)),
                        ],
                      ),
                    ),
                  ),
  ...
  Widget question(String option, String imageUrl, bool check) {

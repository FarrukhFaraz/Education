...
import 'package:new_project/Models/category_result_model.dart';
...
class _PreviousResultState extends State<PreviousResult> {
  ...
  loadData() async {
    ...
    try {
      http.Response response = await http.post(Uri.parse(getPreviousResultURL),
    ...
    return checkConnection
        ...
        : Scaffold(
            appBar: AppBar(
              ...
              elevation: 0,
              centerTitle: true,
              title: const Text("Previous Test Result"),
              leading: InkWell(
                onTap: () {
